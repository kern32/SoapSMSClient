 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "https://smsc.ru/sys/soap.php", wsdlLocation = "https://smsc.ru/sys/soap.php?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICE_QNAME = new QName("https://smsc.ru/sys/soap.php", "Service");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://smsc.ru/sys/soap.php?wsdl");
    ...
    public ServiceSoap getServiceSoap() {
        return super.getPort(new QName("https://smsc.ru/sys/soap.php", "ServiceSoap"), ServiceSoap.class);
    }
    ...
    public ServiceSoap getServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("https://smsc.ru/sys/soap.php", "ServiceSoap"), ServiceSoap.class, features);
    }
